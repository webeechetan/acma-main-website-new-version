...
@section('content')
 ...
 <!-- Banner -->
 <section class="top-space-margin lg-border-radius-0px p-0 position-relative" style="background-image: url({{ asset('frontend')}}/assets/images/about_main_banner.jpg)">
...
<!-- Message -->                                                                    
<section class="background-position-center background-no-repeat" style="background-image: url('{{ asset('assets/images/map.png')}}')">
    <div class="container">
...
<section class="position-relative overflow-hidden pt-0">
    <div class="skrollr-parallax mx-auto pt-10 pb-10 md-pt-12 md-pb-12 border-radius-6px" data-bottom-top="width: 63%" data-center-top="width: 100%;" data-parallax-background-ratio="0.5" style="background-image: url('{{asset('frontend/assets/images/about_big.jpg')}}')">
